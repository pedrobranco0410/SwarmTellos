...
class DroneController(Node):
    ...
    def __init__(self, name):
        ...
        self.gps_sub   = self.create_subscription(NavSatFix,'/drone_' + self.drone_name[5:] + '/gps',self.gps_callback,10)
